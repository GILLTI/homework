...
public class CastingTest extends Tv{
	public static void main(String[] args) {
		...
		smartTv.chUp();
		smartTv.netflix(); //자식 객체의 값은 자식 클래스에 있는 멤버사용
...
//		tv1.netflix()
		...
		//방법2
		Tv tv2 = (Tv)smartTv;
		//tv2는 SmartTv 객체를 참조하지만 업캐스팅으로 인해 Tv 티입으로 취급된다
		//따라서 Tv클래스의 필드와 메소드에만 접근할 수 있다
		
		//방법3
		Tv tv3 = new SmartTv();
		//부모클래스 탕비의 참조 변수로 자식 클래스 타입의 객체를 참조한다
